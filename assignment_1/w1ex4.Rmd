...
result_matrix <- matrix("-",nrow = 8, ncol = length(models), dimnames = list(c("Residual sum of Squares","block", "N", "P", "K","block:N","block:P","block:K"), paste0("model", 1:length(models))))
...
for (i in 1:length(models)) {
  ...
  result_matrix["Residual sum of Squares", i] <- round(anova(models[[i]])[nrow(anova(models[[i]])), "Sum Sq"],2)
