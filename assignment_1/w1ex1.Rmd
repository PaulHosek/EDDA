...
The problem is similar to a sign test in which the first step of finding the test statistic $T = \#(X_i < \mu)$ has already been performed. 
```{r}
k_male = 34
k_female = 28
n_male = k_male + 61
