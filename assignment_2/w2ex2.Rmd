...
```
The prediction interval of the full model is larger ($`r sprintf('%.2f',pred_interv_f[[3]] - pred_interv_f[[2]])`$) than using the model found with the step-up method ($`r sprintf('%.2f',pred_interv_b[[3]] - pred_interv_b[[2]])`$).
